...
train_dataset = build_fewshot_dataset(train_dataset, args.shots)
print(f"Train dataset has {len(train_dataset)} instances.")
target_col = train_dataset.target_col 
print(train_dataset.df[target_col])
...
def train_and_eval_with_cfg(
    ...
    train_loader = DataLoader(train_tensor_frame,
                              ...
                              drop_last=False) # drop_last=false for few-shot learning 
