...
def main(args):
    ...
    save_results(args, model_config, best_test_metrics, train_history)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='TabPerceiverMOE_')
    # config
    ...
    parser.add_argument('--moe_ratio', type=float, default=0.25)
